...
# Create symlinks for arm64-v8a since it's already built
cd "$OUTPUT_DIR/arm64-v8a/ncurses/lib"
ln -sf libncursesw.a libncurses.a 2>/dev/null || true
cd "$OUTPUT_DIR/arm64-v8a/ncurses/include"
...
echo "All remaining ncurses builds complete!"
